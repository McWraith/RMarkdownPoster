...
library(knitr)
library(reticulate)
use_condaenv("Path:/to/your/conda/environment", required = TRUE)
py_run_string("import os as os")
py_run_string("os.environ['QT_QPA_PLATFORM_PLUGIN_PATH'] = 'Path:/to/your/anaconda/files/Anaconda3/Library/plugins/platforms'")
